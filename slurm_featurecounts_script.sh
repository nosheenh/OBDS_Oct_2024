...
# readCounts to count features


 
 featureCounts \
 -a/project/ndwr0122/1_linux/rnaseq/genome/Mus_musculus.GRCm38.102.gtf \
 -t exon \
 -g gene_id \
 ...
 -B -C \
 -T 12 \
 /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam
