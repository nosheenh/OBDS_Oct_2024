...
# samtools index 
# @ specifies threads
 samtools  view -@ 12 -b -h /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.sam > /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.bam
 samtools sort -@ 12 /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.bam > /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam 
 samtools index -@ 12 /project/ndwr0122/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam 
